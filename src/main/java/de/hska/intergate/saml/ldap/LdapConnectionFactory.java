package de.hska.intergate.saml.ldap;
...
public class LdapConnectionFactory {
	public static final void openConnection(){
		final String ldapServer = "ldap://localhost:10389";
		final String ldapSearchBase = "dc=intergate,dc=de";
		
		final String ldapUsername = "cn=Intergate User,ou=Users,dc=intergate,dc=de";
		final String ldapPassword = "123456";
		
		final String ldapAccountToLookup = "cn=Patrick Hofmann,ou=Users,dc=intergate,dc=de";
		...
		try {
			srLdapUser = ldap.findAccountByAccountName(ctx, ldapSearchBase, ldapAccountToLookup);
		} catch (NamingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	    ...
	    String primaryGroupSID = null;
		try {
			primaryGroupSID = ldap.getPrimaryGroupSID(srLdapUser);
		} catch (NamingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
